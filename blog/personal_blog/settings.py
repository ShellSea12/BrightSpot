...
SECRET_KEY = 'django-insecure-(t5)m()z5wi6)3*vo*n(@r#a)!%&z*k*^_p#%u&t*o&&bwlq)s'
...
INSTALLED_APPS = [
    "blog.apps.BlogConfig", # the blog app exists
...
SUMMERNOTE_CONFIG = {
    'summernote': {
        ...
        'width': 600,   # Customize the width of the editor
        'toolbar_air': [
        ...
        'allow_html': True,  # Enable the allow_html option
    },
}
